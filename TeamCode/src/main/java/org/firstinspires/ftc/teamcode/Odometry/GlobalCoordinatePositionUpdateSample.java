...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    //TO-DO  Hardware map names for the encoder wheels. Again, these will change for each robot and need to be updated below
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData("Horizontal left encoder position", horizontal.getCurrentPosition());
